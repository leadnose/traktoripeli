...
export const screenCanvas = document.getElementById("game");
...
export const VIEW_W = screenCanvas.width / PIXEL; // 320
export const VIEW_H = screenCanvas.height / PIXEL; // 200
...
export function nearPoint(px, py, x, y, r) {
